...
<details>
<summary><strong>🤖 Trading/Financial Systems</strong></summary>

```
📈 project-strategy/           - Trading algorithms, backtesting results
⚖️ project-compliance/         - Financial regulations, audit trails  
📊 project-data-sources/       - Market data APIs, data vendor docs
```
</details>
...
```
🎨 project-ux-design/          - UI designs, wireframes, user journeys
📄 project-content/            - Content strategy, copywriting, media
📈 project-analytics/          - User analytics, conversion tracking
```
</details>
...
```
📱 project-platforms/          - iOS/Android configs, store requirements
👥 project-user-experience/    - Mobile UX patterns, accessibility
...
🧪 project-experiments/        - Experiment tracking, hypothesis testing
```
</details>
